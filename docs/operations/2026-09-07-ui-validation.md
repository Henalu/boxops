...
- Resuelto el login 500 de Vercel Preview al habilitar las dos variables publicas de Supabase y redesplegar. Se comprueban en navegador login, recuperacion, rechazo de credenciales ficticias y redirecciones anonimas de `/app` y `/console`; los logs confirman 200/307 y ningun error de funcion durante el recorrido. Esto no sustituye los 34 casos autenticados locales. Detalle en `2026-09-07-guardrail-recheck.md`.
