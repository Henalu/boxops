...
-- - Add a small editable assignment sample with covered, vacant, insufficient
--   and conflicting blocks.
--
...
with sample_assignments (
  ...
  values
    ...
    (1, 20, '00000000-0000-0000-0000-000000200010'::uuid, '00000000-0000-0000-0000-000000200606'::uuid, 1),
...
with sample_assignments (
  ...
  values
    ...
    (1, 20, '00000000-0000-0000-0000-000000200606'::uuid),
